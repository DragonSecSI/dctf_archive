...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateSessionMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhase", 116, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhasePeak", 117, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhase", 118, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhasePeak", 119, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateLapMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhase", 102, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhasePeak", 103, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhase", 104, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhasePeak", 105, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateRecordMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("LeftPowerPhase", 69, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("LeftPowerPhasePeak", 70, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("RightPowerPhase", 71, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("RightPowerPhasePeak", 72, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateAviationAttitudeMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Pitch", 2, 131, 1043038, 0, "radians", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("Roll", 3, 131, 1043038, 0, "radians", false, Type.Sint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Track", 9, 132, 1043038, 0, "radians", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateSegmentLapMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhase", 75, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhasePeak", 76, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhase", 77, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhasePeak", 78, 2, 7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
