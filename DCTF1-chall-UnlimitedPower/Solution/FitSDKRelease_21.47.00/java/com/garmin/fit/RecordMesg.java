...
public class RecordMesg extends Mesg {
    ...
    static {int field_index = 0;
        ...
        field_index++;
        recordMesg.addField(new Field("left_power_phase", LeftPowerPhaseFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        recordMesg.addField(new Field("left_power_phase_peak", LeftPowerPhasePeakFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        recordMesg.addField(new Field("right_power_phase", RightPowerPhaseFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        recordMesg.addField(new Field("right_power_phase_peak", RightPowerPhasePeakFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
