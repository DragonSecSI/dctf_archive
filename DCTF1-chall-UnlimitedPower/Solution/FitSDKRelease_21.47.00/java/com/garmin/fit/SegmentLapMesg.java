...
public class SegmentLapMesg extends Mesg implements MesgWithEvent {
    ...
    static {
        ...
        field_index++;
        segmentLapMesg.addField(new Field("avg_left_power_phase", AvgLeftPowerPhaseFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        segmentLapMesg.addField(new Field("avg_left_power_phase_peak", AvgLeftPowerPhasePeakFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        segmentLapMesg.addField(new Field("avg_right_power_phase", AvgRightPowerPhaseFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
        segmentLapMesg.addField(new Field("avg_right_power_phase_peak", AvgRightPowerPhasePeakFieldNum, 2, 7111111, 0, "degrees", false, Profile.Type.UINT8));
        field_index++;
